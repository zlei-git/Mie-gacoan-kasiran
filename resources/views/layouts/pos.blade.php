...
<body class="h-full flex flex-col antialiased overflow-hidden">
    ...
    <header class="h-16 bg-stone-900 border-b border-stone-800 px-4 sm:px-6 flex items-center justify-between flex-shrink-0">
        ...
        <div class="flex items-center gap-3">
            ...
            <div class="relative">
                <button type="button" 
                        onclick="window.OrderNotifier.toggleDrawer('posOrderNotifDropdown')"
                        class="relative p-2 rounded-xl bg-stone-800 hover:bg-stone-700 text-stone-300 hover:text-white transition flex items-center gap-1.5 border border-stone-700 active:scale-95"
                        title="Notifikasi Pesanan Masuk">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path>
                    </svg>
                    <span id="posOrderNotifBadge" class="hidden px-1.5 py-0.5 rounded-full bg-rose-600 text-white text-[10px] font-black leading-none animate-pulse">0</span>
                </button>

                <!-- Dropdown List of Active Orders -->
                <div id="posOrderNotifDropdown" class="hidden absolute right-0 mt-2 w-80 bg-stone-900 border border-stone-800 rounded-2xl shadow-2xl z-50 overflow-hidden">
                    <div class="p-3.5 border-b border-stone-800 flex items-center justify-between bg-stone-950/60">
                        <div class="flex items-center gap-2">
                            <span class="w-2 h-2 rounded-full bg-rose-500 animate-ping"></span>
                            <span class="font-bold text-xs text-white">Pesanan Baru Masuk</span>
                        </div>
                        <span class="text-[10px] text-stone-400 font-mono">Live Monitoring</span>
                    </div>
                    <div id="posOrderNotifList" class="max-h-72 overflow-y-auto divide-y divide-stone-800/60">
